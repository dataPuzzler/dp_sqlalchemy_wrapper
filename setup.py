...
setup(
    name='dp_sqlalchemy_wrapper',  # Required
    version=version,  # Required
    description='A slim wrapper around sqlalchemy to simplify database setup and common operations',  # Optional
    long_description=long_description,
    long_description_content_type='text/x-rst',
    url='https://github.com/dataPuzzler/dp_sqlalchemy_wrapper',  # Optional
    ...
    keywords='sqlalchemy, wrapper',  # Optional
